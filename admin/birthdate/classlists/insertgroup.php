...
<body>
    ...
    require_once '../src/Models/Insertgroup/Insertgroup.php'; // модель добавления группы
    ?>
    <div id="wrapper">
        <!-- sidebar для student -->
        ...
        <div class="col-lg-12">
            <div id="page-wrapper">
                ...
                <div>
                    ...
                    $id = $birthdate1->id[insertgroup]; //вывод переменной на экран из бд
                    $title = $birthdate1->columns[insertgroup];
                    $smalltext = $birthdate1->columns2[smallinsertgroup];
                    ?>
                ...
                <table id="customers" cellspacing="0" border="1" width="500">
                    <thead>
                        <tr>
                            <th colspan="2" style="text-align: center;">Добавить группу</th>
                        </tr>
                        <tr>
                                ...
                                <div class="col-lg-12">
                                    <form action="" method="POST">
                                        <div class="form-group row">
                                            <label for="first_name" class="col-xs-3 col-form-label mr-2">Добавить
                                                класс</label>
                                            <div class="col-xs-9">
                                                <input type="text" class="form-control" id="stage" name="stage" value="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="last_name" class="col-xs-3 col-form-label mr-2">Добавить букву
                                                класса </label>
                                            <div class="col-xs-9">
                                    ...
                                    <?php
                                    if (isset($_POST['save'])) {
                                        $class = new Birthdate\Insertgroup();
                                        $class->stage = $_POST['stage'];
