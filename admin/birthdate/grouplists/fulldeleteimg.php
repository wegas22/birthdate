...
<body>
    ...
    require_once '../src/Models/Fulldeleteimg/Fulldeleteimg.php'; // модель удаления клиента
    ?>
    <div id="wrapper">
        <!-- sidebar для student -->
        ...
        <div class="col-lg-12">
            <div id="page-wrapper">
                ...
                <div>
                    ...
                    $id = $birthdate1->id[fulldeleteimgst]; //вывод переменной на экран из бд
                    $title = $birthdate1->columns[fulldeleteimgst];
                    $smalltext = $birthdate1->columns2[smallfulldeleteimgst];
                    ?>
                ...
                <?php
                $member3 = new Birthdate\Fulldelete();
                //директрория
                $member3->dir = 'uploads/';
