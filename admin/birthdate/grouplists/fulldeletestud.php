        ...
        <div class="col-lg-12">
            <div id="page-wrapper">
                ...
                <div>
                    ...
                    $id = $birthdate1->id[fulldeletest]; //вывод переменной на экран из бд
                    $title = $birthdate1->columns[fulldeletest];
                    $smalltext = $birthdate1->columns2[smallfulldeletest];
                    ?>
            ...
            <?php
            $member3 = new Birthdate\Fulldeletestud();
            //директрория
            $member3->studentid = $_GET['studentid'];
            $member3->fulldeldstud();
            ?>
        </div>
    </div>
    </div>
