...
var UIColorpicker2 = (function UIColorpicker2() {
	...
	function Colorpicker2(node) {
		...
		this.topic = topic;
		this.picker2_mode = (type === 'HSL') ? 'HSL' : 'HSV';
		this.color.setFormat(this.picker2_mode);
	...
	/*************************************************************************/
	//				Function for generating the color-picker2
	/*************************************************************************/

	Colorpicker2.prototype.createPickingArea = function createPickingArea() {
		var area = document.createElement('div');
		var picker2 = document.createElement('div');

		area.className = 'picking-area';
		picker2.className = 'picker2';

		this.picking_area = area;
		this.color_picker2 = picker2;
		setMouseTracking(area, this.updateColor.bind(this));

		area.appendChild(picker2);
		this.node.appendChild(area);
	};

	Colorpicker2.prototype.createHueArea = function createHueArea() {
		var area = document.createElement('div');
		var picker2 = document.createElement('div');

		area.className = 'hue';
		picker2.className ='slider-picker2';

		this.hue_area = area;
		this.hue_picker2 = picker2;
	...
	Colorpicker2.prototype.createAlphaArea = function createAlphaArea() {
		var area = document.createElement('div');
		...
		this.alpha_picker2 = picker2;
		setMouseTracking(area, this.updateAlphaSlider.bind(this));

		area.appendChild(mask);
		mask.appendChild(picker2);
		this.node.appendChild(area);
	};

	Colorpicker2.prototype.createPreviewBox = function createPreviewBox(e) {
		var preview_box = document.createElement('div');
		var preview_color = document.createElement('div');

	
		preview_color.className = 'preview-color2';
	...
	Colorpicker2.prototype.newInputComponent = function newInputComponent(title, topic, onChangeFunc) {
	...
	Colorpicker2.prototype.createChangeModeButton = function createChangeModeButton() {

		var button = document.createElement('div');
		button.className = 'switch_mode';
		button.addEventListener('click', function() {
			if (this.picker2_mode === 'HSV')
				this.setpicker2Mode('HSL');
			else
				this.setpicker2Mode('HSV');
	...
	Colorpicker2.prototype.updateColor = function updateColor(e) {
		...
		if (this.picker2_mode === 'HSL')
			this.color.setHSL(this.color.hue, saturation, value);

		this.color_picker2.style.left = x - picker2_offset + 'px';
		this.color_picker2.style.top = y - picker2_offset + 'px';
	...
	Colorpicker2.prototype.updateHueSlider = function updateHueSlider(e) {
		...
		this.updateSliderPosition(this.hue_picker2, x);
		this.setHue(hue);
	};

	Colorpicker2.prototype.updateAlphaSlider = function updateAlphaSlider(e) {
		...
		this.updateSliderPosition(this.alpha_picker2, x);
		this.updatePreviewColor();
	...
	Colorpicker2.prototype.setHue = function setHue(value) {
		this.color.setHue(value);

		this.updatepicker2Background();
		this.updateAlphaGradient();
		this.updatePreviewColor();
	...
	Colorpicker2.prototype.updateSLV = function updateSLV() {
		this.updatepicker2Position();
		this.updateAlphaGradient();
		this.updatePreviewColor();
	...
	Colorpicker2.prototype.updatepicker2Position = function updatepicker2Position() {
		var size = this.picking_area.clientWidth;
		var value = 0;
		var offset = 5;
		...
		this.color_picker2.style.left = x - offset + 'px';
		this.color_picker2.style.top = y - offset + 'px';
	};

	Colorpicker2.prototype.updateSliderPosition = function updateSliderPosition(elem, pos) {
		elem.style.left = Math.max(pos - 3, -2) + 'px';
	};

	Colorpicker2.prototype.updateHuepicker2 = function updateHuepicker2() {
		var size = this.hue_area.clientWidth;
		var offset = 1;
		var pos = (this.color.hue * size / 360 ) | 0;
		this.hue_picker2.style.left = pos - offset + 'px';
	};

	Colorpicker2.prototype.updateAlphapicker2 = function updateAlphapicker2() {
		var size = this.alpha_area.clientWidth;
		var offset = 1;
		var pos = (this.color.a * size) | 0;
		this.alpha_picker2.style.left = pos - offset + 'px';
	};
	...
	Colorpicker2.prototype.updatepicker2Background = function updatepicker2Background() {
		var nc = new Color(this.color);
		nc.setHSV(nc.hue, 100, 100);
		this.picking_area.style.backgroundColor = nc.getHexa();
	};

	Colorpicker2.prototype.updateAlphaGradient = function updateAlphaGradient() {
		this.alpha_mask.style.backgroundColor = this.color.getHexa();
	};

	Colorpicker2.prototype.updatePreviewColor = function updatePreviewColor() {
	...
	Colorpicker2.prototype.inputChangeHue = function inputChangeHue(e) {
		var value = parseInt(e.target.value);
		this.setHue(value);
		this.updateHuepicker2();
	};

	Colorpicker2.prototype.inputChangeSaturation = function inputChangeSaturation(e) {
		var value = parseInt(e.target.value);
	...
	Colorpicker2.prototype.inputChangeValue = function inputChangeValue(e) {
		var value = parseInt(e.target.value);
	...
	Colorpicker2.prototype.inputChangeLightness = function inputChangeLightness(e) {
		var value = parseInt(e.target.value);
	...
	Colorpicker2.prototype.inputChangeRed = function inputChangeRed(e) {
		var value = parseInt(e.target.value);
	...
	Colorpicker2.prototype.inputChangeGreen = function inputChangeGreen(e) {
		var value = parseInt(e.target.value);
	...
	Colorpicker2.prototype.inputChangeBlue = function inputChangeBlue(e) {
		var value = parseInt(e.target.value);
	...
	Colorpicker2.prototype.inputChangeAlpha = function inputChangeAlpha(e) {
		...
		this.updateAlphapicker2();
	};

	Colorpicker2.prototype.inputChangeHexa = function inputChangeHexa(e) {
	...
	Colorpicker2.prototype.subscribe = function subscribe(topic, callback) {
		this.subscribers[topic] = callback;
	};

	Colorpicker2.prototype.notify = function notify(topic, value) {
		if (this.subscribers[topic])
			this.subscribers[topic](value);
	};

	/*************************************************************************/
	//							Set picker2 Properties
	/*************************************************************************/

	Colorpicker2.prototype.setColor = function setColor(color) {
		if(color instanceof Color !== true) {
			console.log('Typeof parameter not Color');
			return;
		}

		if (color.format !== this.picker2_mode) {
			color.setFormat(this.picker2_mode);
			color.updateHSX();
		}
	...
	Colorpicker2.prototype.setpicker2Mode = function setpicker2Mode(mode) {
		if (mode !== 'HSV' && mode !== 'HSL')
			return;

		this.picker2_mode = mode;
		this.node.setAttribute('data-mode', this.picker2_mode);
		this.setColor(this.color);
	};
	...
	var setpicker2Mode = function setpicker2Mode(topic, mode) {
		if (picker2s[topic])
			picker2s[topic].setpicker2Mode(mode);
	};

	var setColor = function setColor(topic, color) {
		if (picker2s[topic])
			picker2s[topic].setColor(color);
	};

	var getColor = function getColor(topic) {
		if (picker2s[topic])
			return new Color(picker2s[topic].color);
	};
	...
	var init = function init() {
		var elem = document.querySelectorAll('.ui-color-picker2');
		var size = elem.length;
		for (var i = 0; i < size; i++)
			new Colorpicker2(elem[i]);
	};
...
window.addEventListener("load", function() {
	Colorpicker2Tool.init();
});

var Colorpicker2Tool = (function Colorpicker2Tool() {
	...
	var Color = UIColorpicker2.Color;
	var HSLColor = UIColorpicker2.HSLColor;
	...
	var ColorPalette = (function ColorPalette() {
		...
		ColorSample.prototype.pickColor = function pickColor() {
			UIColorpicker2.setColor('picker2', this.color);
		};
		...
		var Palette = function Palette(text, size) {
			...
			container2.appendChild(palette);
		...
		var createHuePalette = function createHuePalette() {
			...
			UIColorpicker2.subscribe('picker2', function(color) {
			...
			color_palette.appendChild(palette.container2);
		};
		...
		/* Brightness or Lightness - depends on the picker2 mode */
		...
		var isBlankPalette = function isBlankPalette(container2, value) {
			if (value === 0) {
				container2.setAttribute('data-collapsed', 'true');
				return true;
			}

			container2.removeAttribute('data-collapsed');
			return false;
		};
	...
	var ColorInfo = (function ColorInfo() {
		...
		var updateInfo = function updateInfo(color) {
            ...
            console.log(HEXA.value.value)
                document.getElementById("hex").value = HEXA.value.value;
             var color = HEXA.value.value;     
                var c = document.getElementById("hex").value;
                document.getElementById("hex").style.background = color;
		...
		var init = function init() {
			...
			UIColorpicker2.subscribe('picker2', updateInfo);
	...
	/**
	 * Colorpicker2 Samples
	 */
	var Colorpicker2Samples = (function Colorpicker2Samples() {
		...
		ColorSample.prototype.dragStart = function dragStart(e) {
			e.dataTransfer.setData('sampleID', this.uid);
			e.dataTransfer.setData('location', 'picker2-samples');
		};
		...
		ColorSample.prototype.deleteSample = function deleteSample() {
			container2.removeChild(this.node);
			samples[this.uid] = null;
			nr_samples--;
		};

		var updateUI = function updateUI() {
			updatecontainer2Prop();
		...
		var updatecontainer2Prop = function updatecontainer2Prop() {
			samples_per_line = ((container2.clientWidth - 5) / 52) | 0;
			var height = 52 * (1 + (nr_samples / samples_per_line) | 0);
			container2.style.height = height + 10 + 'px';
		};
		...
		var AddSampleButton = (function AddSampleButton() {
			...
			var addButtonClick = function addButtonClick() {
				var sample = new ColorSample();
				container2.appendChild(sample.node);
		...
		var init = function init() {
			container2 = getElemById('picker2-samples');
			...
			container2.addEventListener('click', setActivateSample);
	...
	var CanvasSamples = (function CanvasSamples() {
		...
		var setActiveSample = function setActiveSample(sample) {
			Colorpicker2Samples.unsetActiveSample();
			Tool.unsetVoidSample();
			unsetActiveSample();
			active = sample;
			active.activate();
	...
	var Tool = (function Tool() {
		...
		var createpicker2ModeSwitch = function createpicker2ModeSwitch() {
			...
			icon.className = 'icon picker2-icon';
			...
			function switchPickingModeTo(elem) {
				...
				active = elem;
				active.setAttribute('data-active', 'true');
				UIColorpicker2.setpicker2Mode('picker2', active.textContent);
			};

			var picker2_sw = new StateButton(icon);
			picker2_sw.subscribe(function() {
				if (active === hsv)
		...
		var setpicker2DragAndDrop = function setpicker2DragAndDrop() {
			...
			function drop(e) {
				...
				UIColorpicker2.setColor('picker2', color);
			};

			function dragStart(e) {
				e.dataTransfer.setData('sampleID', 'picker2');
				e.dataTransfer.setData('location', 'picker2');
			};
		};
		...
		var getSampleColorFrom = function getSampleColorFrom(e) {
			...
			if (location === 'picker2')
				return UIColorpicker2.getColor(sampleID);
			if (location === 'picker2-samples')
				return Colorpicker2Samples.getSampleColor(sampleID);
		...
		var init = function init() {
			...
			setpicker2DragAndDrop();
			createpicker2ModeSwitch();
			setVoidSwitch();
		};
